...
enum ENUM_STG_OSCILLATOR_CROSS_ZERO_TYPE {
  ...
  STG_OSCILLATOR_CROSS_ZERO_TYPE_ADX,         // ADX
  STG_OSCILLATOR_CROSS_ZERO_TYPE_ADXW,        // ADXW
...
INPUT ENUM_STG_OSCILLATOR_CROSS_ZERO_TYPE Oscillator_Cross_Zero_Type =
    STG_OSCILLATOR_CROSS_ZERO_TYPE_ADXW;  // Oscillator type
INPUT_GROUP("Oscillator Cross Zero strategy: strategy params");
INPUT float Oscillator_Cross_Zero_LotSize = 0;                // Lot size
INPUT int Oscillator_Cross_Zero_SignalOpenMethod = 2;         // Signal open method
INPUT float Oscillator_Cross_Zero_SignalOpenLevel = 10.0f;    // Signal open level
...
INPUT float Oscillator_Cross_Zero_SignalCloseLevel = 10.0f;   // Signal close level
...
INPUT_GROUP("Oscillator Cross Zero strategy: ADX indicator params");
INPUT ENUM_INDI_ADX_LINE Oscillator_Cross_Zero_Indi_ADX_Fast_Line = LINE_PLUSDI;         // Fast line
INPUT ENUM_INDI_ADX_LINE Oscillator_Cross_Zero_Indi_ADX_Slow_Line = LINE_MINUSDI;        // Slow line to cross
INPUT int Oscillator_Cross_Zero_Indi_ADX_Period = 16;                                    // Averaging period
INPUT ENUM_APPLIED_PRICE Oscillator_Cross_Zero_Indi_ADX_AppliedPrice = PRICE_TYPICAL;    // Applied price
INPUT int Oscillator_Cross_Zero_Indi_ADX_Shift = 0;                                      // Shift
INPUT ENUM_IDATA_SOURCE_TYPE Oscillator_Cross_Zero_Indi_ADX_SourceType = IDATA_BUILTIN;  // Source type
INPUT_GROUP("Oscillator Cross Zero strategy: ADXW indicator params");
INPUT ENUM_INDI_ADX_LINE Oscillator_Cross_Zero_Indi_ADXW_Fast_Line = LINE_PLUSDI;         // Fast line
INPUT ENUM_INDI_ADX_LINE Oscillator_Cross_Zero_Indi_ADXW_Slow_Line = LINE_MINUSDI;        // Slow line to cross
INPUT int Oscillator_Cross_Zero_Indi_ADXW_Period = 16;                                    // Averaging period
INPUT ENUM_APPLIED_PRICE Oscillator_Cross_Zero_Indi_ADXW_AppliedPrice = PRICE_TYPICAL;    // Applied price
INPUT int Oscillator_Cross_Zero_Indi_ADXW_Shift = 0;                                      // Shift
INPUT ENUM_IDATA_SOURCE_TYPE Oscillator_Cross_Zero_Indi_ADXW_SourceType = IDATA_BUILTIN;  // Source type
INPUT_GROUP("Oscillator strategy: MACD indicator params");
INPUT ENUM_SIGNAL_LINE Oscillator_Cross_Zero_Indi_MACD_Fast_Line = LINE_SIGNAL;       // Fast line
INPUT ENUM_SIGNAL_LINE Oscillator_Cross_Zero_Indi_MACD_Slow_Line = LINE_MAIN;         // Slow line
...
INPUT ENUM_SIGNAL_LINE Oscillator_Cross_Zero_Indi_RVI_Fast_Line = LINE_SIGNAL;           // Fast line
INPUT ENUM_SIGNAL_LINE Oscillator_Cross_Zero_Indi_RVI_Slow_Line = LINE_MAIN;             // Slow line
...
class Stg_Oscillator_Cross_Zero : public Strategy {
 ...
 public:
  ...
  bool IsValidEntry(IndicatorBase *_indi, int _shift = 0) {
    ...
    switch (Oscillator_Cross_Zero_Type) {
      case STG_OSCILLATOR_CROSS_ZERO_TYPE_ADX:
        ...
        break;
      case STG_OSCILLATOR_CROSS_ZERO_TYPE_ADXW:
  ...
  void OnInit() {
    ...
    switch (Oscillator_Cross_Zero_Type) {
      case STG_OSCILLATOR_CROSS_ZERO_TYPE_ADX:  // ADX
      {
        IndiADXParams _adx_params(::Oscillator_Cross_Zero_Indi_ADX_Period,
                                  ::Oscillator_Cross_Zero_Indi_ADX_AppliedPrice,
                                  ::Oscillator_Cross_Zero_Indi_ADX_Shift);
        _adx_params.SetDataSourceType(::Oscillator_Cross_Zero_Indi_ADX_SourceType);
        _adx_params.SetTf(Get<ENUM_TIMEFRAMES>(STRAT_PARAM_TF));
        SetIndicator(new Indi_ADX(_adx_params), ::Oscillator_Cross_Zero_Type);
        // sparams.SetLineFast(0); // @todo: Fix Strategy to allow custom params stored in sparam.
        ssparams.SetLineFast((uint)Oscillator_Cross_Zero_Indi_ADX_Fast_Line);
        ssparams.SetLineSlow((uint)Oscillator_Cross_Zero_Indi_ADX_Slow_Line);
        break;
      }
      case STG_OSCILLATOR_CROSS_ZERO_TYPE_ADXW:  // ADXW
      {
        IndiADXWParams _adxw_params(::Oscillator_Cross_Zero_Indi_ADXW_Period,
                                    ::Oscillator_Cross_Zero_Indi_ADXW_AppliedPrice,
                                    ::Oscillator_Cross_Zero_Indi_ADXW_Shift);
        _adxw_params.SetDataSourceType(::Oscillator_Cross_Zero_Indi_ADXW_SourceType);
        _adxw_params.SetTf(Get<ENUM_TIMEFRAMES>(STRAT_PARAM_TF));
        SetIndicator(new Indi_ADXW(_adxw_params), ::Oscillator_Cross_Zero_Type);
        // sparams.SetLineFast(0); // @todo: Fix Strategy to allow custom params stored in sparam.
        ssparams.SetLineFast((uint)Oscillator_Cross_Zero_Indi_ADXW_Fast_Line);
      ...
      case STG_OSCILLATOR_CROSS_ZERO_TYPE_MACD:  // MACD
      {
        ...
        ssparams.SetLineFast((uint)Oscillator_Cross_Zero_Indi_MACD_Fast_Line);
      ...
      case STG_OSCILLATOR_CROSS_ZERO_TYPE_RVI:  // RVI
      {
        ...
        ssparams.SetLineFast((uint)Oscillator_Cross_Zero_Indi_RVI_Fast_Line);
        ssparams.SetLineSlow((uint)Oscillator_Cross_Zero_Indi_RVI_Slow_Line);
        break;
      }
